						...
						<div class="controls">
							<select id="language_id" name="language_id">
								<c:forEach items="${applicationScope.languages }" var="item">
									<option value="${item.id}" <c:if test="${recruit.language_id == item.id }">selected="selected"</c:if>>
										${item.name}
									</option>
								</c:forEach>
							</select>
...
function save(obj) {
	...
	$("#fm").form({
		url:"${pageContext.request.contextPath}/manage/editRecruit.do",
